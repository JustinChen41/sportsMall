		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				var html= '';
	            	...
	            	html += '				<div class="filePicker">添加照片</div>';
	            	html += '				<input id="fileImage" type="file" size="30" name="imgFile[]" '+multiple+'>';
	            	html += '			</div>';
					...
					html += '	</div>';
					html += '	<input type="hidden" id="fileIndexs" name="fileIndexs" value="0">';
					html += '	<input type="hidden" id="kids" name="kids" value="">';
					html += '</form>';
