	...
	*/
    ...
    jeDt.initDate = function(opts) {
        ...
        var createDiv = function(disCell, self, dis) {
            ...
            dateDiv.id = self;
            dateDiv.style.cssText = "z-index:" + (dis == true ? "" :opts.zIndex || 99999) + ";position:" + (dis == true ? "relative" :"absolute") + ";display:block;";
    ...
    jeDt.getStrhms = function(opts, lyerCell, hmsArr) {
        ...
        var parsehms = function(str) {
            ...
            var isHMtime = ymdstr == "YYYY-MM-DD-hh-mm" ? timeArr[1] :timeArr[0];
