...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        $div3.append($btnSubmit).append($btnCancel).append('<p style="float:left;margin-top:10px;color: #999;">支持煤炭江湖内部链接</p>');
        ...
        $btnSubmit.click(function (e) {
			...
			if(url.indexOf("www.meitanjianghu.com") < 0){
				$urlInput.val("").attr("placeholder", "添加失败");
				return false;
			}
